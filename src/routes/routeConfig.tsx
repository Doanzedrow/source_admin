...
export const routesArray: RouteConfig[] = [
  ...
  },
  {
    ...
    layout: 'main',
    allowedRoles: ['superadmin', 'admin'],
    requiredPermission: { module: 'shift', action: 'view' },
    component: lazy(() => import('@/modules/shift/pages/ShiftList')),
  },
  {
    id: RouteKey.ShiftCreate,
    name: 'Create Shift',
    path: '/shift/create',
    layout: 'main',
    allowedRoles: ['superadmin', 'admin'],
    requiredPermission: { module: 'shift', action: 'create' },
    component: lazy(() => import('@/modules/shift/pages/ShiftUpsert')),
  },
  {
    id: RouteKey.ShiftEdit,
    name: 'Edit Shift',
    path: '/shift/edit/:id',
    layout: 'main',
    allowedRoles: ['superadmin', 'admin'],
    requiredPermission: { module: 'shift', action: 'update' },
    component: lazy(() => import('@/modules/shift/pages/ShiftUpsert')),
  },
  {
    id: RouteKey.Users,
